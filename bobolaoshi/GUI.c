...
void start_show()
{
    LCD_PutString24(100,20,"九江学院",Red,White);
    LCD_PutString24(48,200,"电子工程学院",Red,White);
    LCD_PutString24(100,240,"A1612",Red  ,White);
    LCD_PutString24(20,264,"竞知向学,厚德笃行",Red ,White);
    Show_Image(0,80,0,80,gImage_xiaohui);
}

void main_menu()
{
    LCD_PutString24(72,20,"波形类型",Red,White);
    LCD_PutString24(72,60,"1:正弦波",Red,White);
    LCD_PutString24(72,100,"2:三角波",Red,White);
    LCD_PutString24(72,140,"3:方波",Red,White);
 //   Show_Image(40,120,200,280,gImage_1);
//    LCD_PutString24(100,20,"波形类型",Red,White);
}
